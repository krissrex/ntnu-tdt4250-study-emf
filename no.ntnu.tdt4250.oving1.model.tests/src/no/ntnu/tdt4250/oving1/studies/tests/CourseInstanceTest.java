...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Course Instance</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class CourseInstanceTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		org.eclipse.acceleo.query.delegates.DelegateUtils.setValidationDelegates(StudiesPackage.eINSTANCE);
		DelegateUtils.setSettingDelegates(StudiesPackage.eINSTANCE);
		DelegateUtils.setInvocationDelegates(StudiesPackage.eINSTANCE);
		todo doesnt work https://wiki.eclipse.org/OCL/OCLinEcore#Registration
	}
	...
	/**
	 * Tests the '{@link no.ntnu.tdt4250.oving1.studies.CourseInstance#getInstanceName() <em>Instance Name</em>}' feature getter.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void testGetInstanceName() {
		...
		String instanceName = fixture.getInstanceName();
