 ...
 * </p>
 * <ul>
 * <li>{@link no.ntnu.tdt4250.oving1.studies.impl.CourseInstanceImpl#getCourse
 * <em>Course</em>}</li>
 * <li>{@link no.ntnu.tdt4250.oving1.studies.impl.CourseInstanceImpl#getYear
 * <em>Year</em>}</li>
 * <li>{@link no.ntnu.tdt4250.oving1.studies.impl.CourseInstanceImpl#getSemester
 * <em>Semester</em>}</li>
 * <li>{@link no.ntnu.tdt4250.oving1.studies.impl.CourseInstanceImpl#getInstanceName
...
public class CourseInstanceImpl extends MinimalEObjectImpl.Container implements CourseInstance {
	...
	/**
	 * The default value of the '{@link #getSemester() <em>Semester</em>}'
	...
	/**
	 * The cached setting delegate for the '{@link #getInstanceName() <em>Instance
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate INSTANCE_NAME__ESETTING_DELEGATE = ((EStructuralFeature.Internal) StudiesPackage.Literals.COURSE_INSTANCE__INSTANCE_NAME)
			.getSettingDelegate();
		...
		if (course != null && course.eIsProxy()) {
			...
			if (course != oldCourse) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StudiesPackage.COURSE_INSTANCE__COURSE,
							oldCourse, course));
			}
		}
		return course;
	...
	public void setCourse(Course newCourse) {
		...
		course = newCourse;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StudiesPackage.COURSE_INSTANCE__COURSE, oldCourse,
					course));
	}
	...
	public void setSemester(SemesterCode newSemester) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StudiesPackage.COURSE_INSTANCE__SEMESTER, oldSemester,
					semester));
	}
