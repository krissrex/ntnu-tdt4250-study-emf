...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Study Instance</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link no.ntnu.tdt4250.oving1.studies.impl.StudyInstanceImpl#getStudy <em>Study</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.oving1.studies.impl.StudyInstanceImpl#getStartYear <em>Start Year</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.oving1.studies.impl.StudyInstanceImpl#getYear <em>Year</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StudyInstanceImpl extends MinimalEObjectImpl.Container implements StudyInstance {
	/**
	 * The cached value of the '{@link #getStartYear() <em>Start Year</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getStartYear()
	 * @generated
	...
	public Study getStudy() {
		if (eContainerFeatureID() != StudiesPackage.STUDY_INSTANCE__STUDY) return null;
	...
	public void setStudy(Study newStudy) {
		if (newStudy != eInternalContainer() || (eContainerFeatureID() != StudiesPackage.STUDY_INSTANCE__STUDY && newStudy != null)) {
			...
			if (newStudy != null)
				msgs = ((InternalEObject)newStudy).eInverseAdd(this, StudiesPackage.STUDY__STUDY_INSTANCES, Study.class, msgs);
			msgs = basicSetStudy(newStudy, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StudiesPackage.STUDY_INSTANCE__STUDY, newStudy, newStudy));
	}
	...
	public NotificationChain basicSetStartYear(StudyYear newStartYear, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StudiesPackage.STUDY_INSTANCE__START_YEAR, oldStartYear, newStartYear);
	...
	public void setStartYear(StudyYear newStartYear) {
		if (newStartYear != startYear) {
			NotificationChain msgs = null;
			if (startYear != null)
				msgs = ((InternalEObject)startYear).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StudiesPackage.STUDY_INSTANCE__START_YEAR, null, msgs);
			if (newStartYear != null)
				msgs = ((InternalEObject)newStartYear).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StudiesPackage.STUDY_INSTANCE__START_YEAR, null, msgs);
			msgs = basicSetStartYear(newStartYear, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StudiesPackage.STUDY_INSTANCE__START_YEAR, newStartYear, newStartYear));
	}
