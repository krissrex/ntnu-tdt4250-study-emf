 ...
 *   <li>{@link no.ntnu.tdt4250.oving1.studies.impl.UniversityImpl#getCourseInstances <em>Course Instances</em>}</li>
...
public class UniversityImpl extends MinimalEObjectImpl.Container implements University {
	...
	public EList<CourseInstance> getCourseInstances() {
		if (courseInstances == null) {
			courseInstances = new EObjectContainmentEList<CourseInstance>(CourseInstance.class, this, StudiesPackage.UNIVERSITY__COURSE_INSTANCES);
		}
