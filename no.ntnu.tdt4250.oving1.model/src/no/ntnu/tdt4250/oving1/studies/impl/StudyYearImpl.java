 ...
 *   <li>{@link no.ntnu.tdt4250.oving1.studies.impl.StudyYearImpl#getAutumnSemester <em>Autumn Semester</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StudyYearImpl extends MinimalEObjectImpl.Container implements StudyYear {
	...
	/**
	 * The cached value of the '{@link #getAutumnSemester() <em>Autumn Semester</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected Semester autumnSemester;
	/**
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public Semester getAutumnSemester() {
		return autumnSemester;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAutumnSemester(Semester newAutumnSemester, NotificationChain msgs) {
		Semester oldAutumnSemester = autumnSemester;
		autumnSemester = newAutumnSemester;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StudiesPackage.STUDY_YEAR__AUTUMN_SEMESTER, oldAutumnSemester, newAutumnSemester);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setAutumnSemester(Semester newAutumnSemester) {
		if (newAutumnSemester != autumnSemester) {
			NotificationChain msgs = null;
			if (autumnSemester != null)
				msgs = ((InternalEObject)autumnSemester).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StudiesPackage.STUDY_YEAR__AUTUMN_SEMESTER, null, msgs);
			if (newAutumnSemester != null)
				msgs = ((InternalEObject)newAutumnSemester).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StudiesPackage.STUDY_YEAR__AUTUMN_SEMESTER, null, msgs);
			msgs = basicSetAutumnSemester(newAutumnSemester, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StudiesPackage.STUDY_YEAR__AUTUMN_SEMESTER, newAutumnSemester, newAutumnSemester));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StudiesPackage.STUDY_YEAR__AUTUMN_SEMESTER:
				return basicSetAutumnSemester(null, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StudiesPackage.STUDY_YEAR__SPRING_SEMESTER:
				...
				return;
			case StudiesPackage.STUDY_YEAR__AUTUMN_SEMESTER:
				setAutumnSemester((Semester)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case StudiesPackage.STUDY_YEAR__SPRING_SEMESTER:
				...
				return;
			case StudiesPackage.STUDY_YEAR__AUTUMN_SEMESTER:
				setAutumnSemester((Semester)null);
				return;
		}
