 ...
 * </p>
 * <ul>
 * <li>{@link no.ntnu.tdt4250.oving1.studies.impl.StudyYearImpl#getNextYear
 * <em>Next Year</em>}</li>
 * <li>{@link no.ntnu.tdt4250.oving1.studies.impl.StudyYearImpl#getProgramName
 * <em>Program Name</em>}</li>
 * <li>{@link no.ntnu.tdt4250.oving1.studies.impl.StudyYearImpl#getSpringSemester
 * <em>Spring Semester</em>}</li>
 * <li>{@link no.ntnu.tdt4250.oving1.studies.impl.StudyYearImpl#getFallSemester
 * <em>Fall Semester</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StudyYearImpl extends MinimalEObjectImpl.Container implements StudyYear {
    /**
     * The cached value of the '{@link #getNextYear() <em>Next Year</em>}'
    ...
    /**
     * The default value of the '{@link #getProgramName() <em>Program Name</em>}'
    ...
    /**
     * The cached value of the '{@link #getProgramName() <em>Program Name</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getProgramName()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getSpringSemester() <em>Spring
    ...
    /**
     * The cached value of the '{@link #getFallSemester() <em>Fall Semester</em>}'
    ...
    public EList<StudyYear> getNextYear() {
        if (nextYear == null) {
            nextYear = new EObjectContainmentEList<StudyYear>(StudyYear.class, this,
                    StudiesPackage.STUDY_YEAR__NEXT_YEAR);
        }
        return nextYear;
    }
    ...
    public void setProgramName(String newProgramName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, StudiesPackage.STUDY_YEAR__PROGRAM_NAME,
    ...
    public NotificationChain basicSetSpringSemester(Semester newSpringSemester, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    StudiesPackage.STUDY_YEAR__SPRING_SEMESTER, oldSpringSemester, newSpringSemester);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setSpringSemester(Semester newSpringSemester) {
        if (newSpringSemester != springSemester) {
            ...
            if (springSemester != null)
                msgs = ((InternalEObject) springSemester).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - StudiesPackage.STUDY_YEAR__SPRING_SEMESTER, null, msgs);
            if (newSpringSemester != null)
                msgs = ((InternalEObject) newSpringSemester).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - StudiesPackage.STUDY_YEAR__SPRING_SEMESTER, null, msgs);
            msgs = basicSetSpringSemester(newSpringSemester, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, StudiesPackage.STUDY_YEAR__SPRING_SEMESTER,
                    newSpringSemester, newSpringSemester));
    }
    ...
    public NotificationChain basicSetFallSemester(Semester newFallSemester, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    StudiesPackage.STUDY_YEAR__FALL_SEMESTER, oldFallSemester, newFallSemester);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setFallSemester(Semester newFallSemester) {
        if (newFallSemester != fallSemester) {
            ...
            if (fallSemester != null)
                msgs = ((InternalEObject) fallSemester).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - StudiesPackage.STUDY_YEAR__FALL_SEMESTER, null, msgs);
            if (newFallSemester != null)
                msgs = ((InternalEObject) newFallSemester).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - StudiesPackage.STUDY_YEAR__FALL_SEMESTER, null, msgs);
            msgs = basicSetFallSemester(newFallSemester, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, StudiesPackage.STUDY_YEAR__FALL_SEMESTER,
                    newFallSemester, newFallSemester));
    }
