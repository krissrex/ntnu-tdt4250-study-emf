...
public class StudiesValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	protected static final String STUDY_YEAR__SPRING_CONTAINS_ONLY_SPRING_CLASSES__EEXPRESSION = "if self.springSemester <> null then not self.springSemester.courses.semester.toString()->exists(name | name <> 'Spring') else true endif";
