...
public class StudiesValidator extends EObjectValidator {
    ...
    public boolean validateCourse(Course course, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        if (result || diagnostics != null)
            result &= validateCourse_shouldStartWith2Or3Letters(course, diagnostics, context);
        if (result || diagnostics != null)
            result &= validateCourse_shouldEndWithNumbers(course, diagnostics, context);
        return result;
    }

    /**
     * The cached validation expression for the shouldStartWith2Or3Letters
     * constraint of '<em>Course</em>'. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @generated
     */
     ...
     * @generated
     */
    public boolean validateCourse_shouldStartWith2Or3Letters(Course course, DiagnosticChain diagnostics,
            Map<Object, Object> context) {
        return validate(StudiesPackage.Literals.COURSE, course, diagnostics, context,
                "http://www.eclipse.org/acceleo/query/1.0", "shouldStartWith2Or3Letters",
                COURSE__SHOULD_START_WITH2_OR3_LETTERS__EEXPRESSION, Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0);
    }

    /**
     * The cached validation expression for the shouldEndWithNumbers constraint of
     ...
     * @generated
     */
    public boolean validateCourse_shouldEndWithNumbers(Course course, DiagnosticChain diagnostics,
            Map<Object, Object> context) {
        return validate(StudiesPackage.Literals.COURSE, course, diagnostics, context,
                "http://www.eclipse.org/acceleo/query/1.0", "shouldEndWithNumbers",
                COURSE__SHOULD_END_WITH_NUMBERS__EEXPRESSION, Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0);
    }
     ...
     * @generated
     */
    public boolean validateStudyInstance(StudyInstance studyInstance, DiagnosticChain diagnostics,
            Map<Object, Object> context) {
    ...
    public boolean validateStudyYear(StudyYear studyYear, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        if (result || diagnostics != null)
            result &= validateStudyYear_springContainsOnlySpringClasses(studyYear, diagnostics, context);
        if (result || diagnostics != null)
            result &= validateStudyYear_fallContainsOnlyFallClasses(studyYear, diagnostics, context);
        return result;
    }

    /**
     * The cached validation expression for the springContainsOnlySpringClasses
     * constraint of '<em>Study Year</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * Validates the springContainsOnlySpringClasses constraint of '<em>Study
     * Year</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    public boolean validateStudyYear_springContainsOnlySpringClasses(StudyYear studyYear, DiagnosticChain diagnostics,
            Map<Object, Object> context) {
        return validate(StudiesPackage.Literals.STUDY_YEAR, studyYear, diagnostics, context,
                "http://www.eclipse.org/acceleo/query/1.0", "springContainsOnlySpringClasses",
                STUDY_YEAR__SPRING_CONTAINS_ONLY_SPRING_CLASSES__EEXPRESSION, Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0);
    }

    /**
     * Validates the fallContainsOnlyFallClasses constraint of '<em>Study
     * Year</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    public boolean validateStudyYear_fallContainsOnlyFallClasses(StudyYear studyYear, DiagnosticChain diagnostics,
            Map<Object, Object> context) {
     ...
     * @generated
     */
    public boolean validateStudyCourse(StudyCourse studyCourse, DiagnosticChain diagnostics,
            Map<Object, Object> context) {
    ...
    public boolean validateSemester(Semester semester, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        if (result || diagnostics != null)
            result &= validateSemester_shouldHave30StudyPoints(semester, diagnostics, context);
        return result;
    }

    /**
     * The cached validation expression for the shouldHave30StudyPoints constraint
     * of '<em>Semester</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
     ...
     * @generated
     */
    public boolean validateSemester_shouldHave30StudyPoints(Semester semester, DiagnosticChain diagnostics,
            Map<Object, Object> context) {
        return validate(StudiesPackage.Literals.SEMESTER, semester, diagnostics, context,
                "http://www.eclipse.org/acceleo/query/1.0", "shouldHave30StudyPoints",
                SEMESTER__SHOULD_HAVE30_STUDY_POINTS__EEXPRESSION, Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0);
    }
     ...
     * @generated
     */
    public boolean validateSemesterCode(SemesterCode semesterCode, DiagnosticChain diagnostics,
            Map<Object, Object> context) {
        return true;
    }
