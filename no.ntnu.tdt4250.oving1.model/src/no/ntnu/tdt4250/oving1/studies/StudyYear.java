 ...
 *   <li>{@link no.ntnu.tdt4250.oving1.studies.StudyYear#getFallSemester <em>Fall Semester</em>}</li>
 * </ul>
 *
 ...
 *        annotation="http://www.eclipse.org/acceleo/query/1.0 springContainsOnlySpringClasses='if self.springSemester &lt;&gt; null then self.springSemester.courses.semester.name-&gt;exists(name | name &lt;&gt; \'Spring\') else true endif' fallContainsOnlySpringClasses='if self.fallSemester &lt;&gt; null then self.fallSemester.courses.semester.name-&gt;exists(name | name &lt;&gt; \'Fall\') else true endif'"
 * @generated
 */
public interface StudyYear extends EObject {
	...
	/**
	 * Sets the value of the '{@link no.ntnu.tdt4250.oving1.studies.StudyYear#getFallSemester <em>Fall Semester</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
